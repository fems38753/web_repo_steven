...
<head>
    <meta charset="UTF-8">
    <title>Pembayaran Mandiri Virtual Account</title>
...
<body>
    <div class="container">
        ...
        <h2>Pembayaran via Mandiri Virtual Account</h2>
        ...
        <div class="steps">
            ...
            <ol>
                <li>Buka aplikasi Livin' by Mandiri atau Internet Banking Mandiri.</li>
