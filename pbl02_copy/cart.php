  ...
  <div class="cart-container">
    ...
    <div class="cart-right">
      ...
      <form>
        ...
        <input type="text" placeholder="Masukkan Alamat" /><br>
        <label>Shipping Choice</label>
        <div class="shipping-options">
          <img src="images/5.png" alt="JNE" />
          <img src="images/6.png" alt="J&T" />
          <img src="images/7.png" alt="SiCepat" />
        </div>
        ...
        <textarea placeholder="Silakan tinggalkan pesan"></textarea>
